          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img
                ...
                className="rounded-2xl shadow-2xl w-[550px] h-[600px]"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-purple-light/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex space-x-8 animate-testimonial-scroll">
              {[...testimonials, ...testimonials].map((t, i) => (
                <Card key={i} className="bg-white shadow-lg flex-shrink-0" style={{ width: '20rem' }}>
